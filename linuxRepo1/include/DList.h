...
typedef void(*fp_delete)(void *data);//用于对数据节点进行删除的操作，由用户实现
...
*@retval
*/
DList *dlist_init(fp_delete deleteData, void *lock);
...
*@return						N/A
*/
void dlist_delete_node(DList *pList, DListNode *pDelNode);
