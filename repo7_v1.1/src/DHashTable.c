...
*@retval			
*/
DHashTable *dhashTable_init(size_t tableSize, fp_hash_func hashFunc, fp_delete_data delete_data)
{
    if(0 == tableSize)
    {
        return NULL;
    ...
    pHashTable->count = 0;
    pHashTable->delete_data = delete_data;
...
int dhashTable_insert_data(DHashTable *pHashTable, const void *key, size_t keySize, void *data)
{
    ...
    {
        pHashTable->listArray[index] = dlist_init(NULL, pHashTable->delete_data);
    }
